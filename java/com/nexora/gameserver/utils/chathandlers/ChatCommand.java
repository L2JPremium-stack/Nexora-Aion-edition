package com.nexora.gameserver.utils.chathandlers;
...
public abstract class ChatCommand {
	...
	protected String toErrorMessage(IllegalArgumentException e) {
		...
		if (msg != null && msg.startsWith("No enum constant ")) { // "No enum constant com.nexora.gameserver.model.siege.SiegeRace.invalidName"
			String[] enumParts = msg.substring(17).split("\\."); // -> ["com", "nexora", "gameserver", "model", "siege", "SiegeRace", "invalidName"]
