...
import com.nexora.gameserver.controllers.observer.TerrainZoneCollisionMaterialActor;
...
import com.nexora.gameserver.model.items.GodStone;
import com.nexora.gameserver.model.stats.container.StatEnum;
import com.nexora.gameserver.model.templates.item.GodstoneInfo;
...
import com.nexora.gameserver.network.aion.serverpackets.SM_ATTACK;
...
import com.nexora.gameserver.network.aion.serverpackets.SM_SKILL_CANCEL;
...
import com.nexora.gameserver.skillengine.model.*;
import com.nexora.gameserver.skillengine.model.Skill.SkillMethod;
import com.nexora.gameserver.skillengine.properties.Properties.CastState;
import com.nexora.gameserver.taskmanager.tasks.MovementNotifyTask;
...
import com.nexora.gameserver.world.zone.ZoneUpdateService;
...
public abstract class CreatureController<T extends Creature> extends VisibleObjectController<T> {
	 ...
	 * Should ONLY be called from {@link com.nexora.gameserver.model.stats.container.CreatureLifeStats} to avoid duplicate death events.
	 */
