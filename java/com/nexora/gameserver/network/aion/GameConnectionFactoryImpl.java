...
import com.nexora.commons.network.ConnectionFactory;
import com.nexora.commons.network.Dispatcher;
import com.nexora.gameserver.configs.network.NetworkConfig;
import com.nexora.gameserver.network.sequrity.FloodManager;
import com.nexora.gameserver.network.sequrity.FloodManager.Result;
...
public class GameConnectionFactoryImpl implements ConnectionFactory {
	...
	/**
	 * Create a new {@link com.nexora.commons.network.AConnection AConnection} instance.<br>
	 * 
	 * @param socket
	 *          that new {@link com.nexora.commons.network.AConnection AConnection} instance will represent.<br>
	 * @param dispatcher
	 *          to which new connection will be registered.<br>
	 * @return a new instance of {@link com.nexora.commons.network.AConnection AConnection}<br>
	 * @throws IOException
	 * @see com.nexora.commons.network.AConnection
	 * @see com.nexora.commons.network.Dispatcher
	 */
