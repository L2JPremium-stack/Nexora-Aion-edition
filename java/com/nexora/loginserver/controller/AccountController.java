package com.nexora.loginserver.controller;

import java.util.HashMap;
import java.util.Map;
import java.util.concurrent.ConcurrentHashMap;

import com.nexora.commons.utils.NetworkUtils;
...
import com.nexora.loginserver.dao.AccountTimeDAO;
import com.nexora.loginserver.model.Account;
import com.nexora.loginserver.model.AccountTime;
...
import com.nexora.loginserver.network.aion.LoginConnection.State;
import com.nexora.loginserver.network.aion.SessionKey;
import com.nexora.loginserver.network.aion.serverpackets.SM_ACCOUNT_BANNED_2;
import com.nexora.loginserver.network.aion.serverpackets.SM_ACCOUNT_KICK;
import com.nexora.loginserver.network.aion.serverpackets.SM_SERVER_LIST;
import com.nexora.loginserver.network.aion.serverpackets.SM_UPDATE_SESSION;
import com.nexora.loginserver.network.gameserver.GsConnection;
import com.nexora.loginserver.network.gameserver.serverpackets.SM_ACCOUNT_AUTH_RESPONSE;
import com.nexora.loginserver.network.gameserver.serverpackets.SM_GS_CHARACTER_RESPONSE;
import com.nexora.loginserver.utils.AccountUtils;
import com.nexora.loginserver.utils.ExternalAuth;
...
public class AccountController {
	 ...
	 * If {@link com.nexora.loginserver.configs.Config#ACCOUNT_AUTO_CREATION} is enabled - creates new account.<br>
	 * 
	 * @param name
	 *          name of account
	 * @param password
