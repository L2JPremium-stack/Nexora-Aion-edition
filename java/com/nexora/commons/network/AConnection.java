...
import com.nexora.commons.network.packet.BaseServerPacket;
import com.nexora.commons.options.Assertion;
...
public abstract class AConnection<T extends BaseServerPacket>
{
	...
	/**
	 * Its guaranteed that closePacket will be sent before closing connection, but all past and future packets wont. Connection will be closed [by Dispatcher Thread], and onDisconnect() method will be called to clear all other things.
	 * @param closePacket Packet that will be sent before closing. If closePacket is null, regular {@link #close()} will be called instead.
	 */
